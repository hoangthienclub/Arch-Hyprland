...
if [ -f Hyprland-Dots.tar.gz ]; then
  ...
  latest_version=$(curl -s https://api.github.com/repos/hoangthienclub/Hyprland-Dots/releases/latest | grep "tag_name" | cut -d '"' -f 4 | sed 's/v//')
...
latest_tag=$(curl -s https://api.github.com/repos/hoangthienclub/Hyprland-Dots/releases/latest | grep "tag_name" | cut -d '"' -f 4)
...
latest_tarball_url=$(curl -s https://api.github.com/repos/hoangthienclub/Hyprland-Dots/releases/latest | grep "tarball_url" | cut -d '"' -f 4)
